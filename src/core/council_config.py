...
COUNCIL_MEMBERS: Dict[str, CouncilMemberConfig] = {
    "botanist": CouncilMemberConfig(
        ...
        collection="botanical_knowledge_768",
        graph_collection="botanical_entities_768",
    ...
    "chemist": CouncilMemberConfig(
        ...
        collection="botanical_knowledge_768", # Shares botanical/scientific knowledge base
        graph_collection="botanical_entities_768", # Shares botanical graph
    ...
    "pharmacologist": CouncilMemberConfig(
        ...
        name="Pharmacologist",
        role="Pharmacologist",
        collection="pharmacological_knowledge_768",
        graph_collection="pharmacological_entities_768",
    ...
    "epidemiologist": CouncilMemberConfig(
        ...
        collection="studies_data_768",
        graph_collection="studies_entities_768",
    ...
    "product_expert": CouncilMemberConfig(
        ...
        collection="production_knowledge_768",
        graph_collection="production_entities_768",
